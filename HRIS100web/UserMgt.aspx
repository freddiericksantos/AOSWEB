<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.master" CodeBehind="UserMgt.aspx.vb" Inherits="AOS100web.UserMgt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentOfAdministrator" runat="server">
	...
	<table style="width: 98%; font-family: 'Segoe UI'; float: left; margin-top: -2px; padding-top: 0px">
		...
		<tr style="height: 26px; ">
			...
			<td style="border: 1px solid #000000; width: 500px; background-color: floralwhite; " colspan="6" rowspan="16">
				<asp:Panel ID="Panel2" runat="server" Width="98%" Height="750px">
		...
		<tr style="height: 26px; ">
			...
			<td style="border: 1px solid #000000; width: 200px; text-align:left; " colspan="2">
				<%--<asp:TextBox ID="txtUserID" runat="server" Font-Names="Segoe UI" Font-Size="small"></asp:TextBox>--%>
				<%--<asp:TextBox ID="TextBox1" runat="server" Font-Names="Segoe UI" Font-Size="small" CssClass="txtBoxL"></asp:TextBox>--%>
				<asp:TextBox ID="TextBox3" runat="server" Font-Names="Segoe UI" Font-Size="small" MaxLength="25" CssClass="txtBoxL"></asp:TextBox>
			</td>
			<td style="width: 5px; "></td>
		...
		<tr style="height: 26px; ">
			...
			<td style="border: 1px solid #000000; width: 200px; text-align:left; " colspan="2">
				<%--<asp:TextBox ID="txtUserPass" runat="server" Font-Names="Segoe UI" Font-Size="small" TextMode="Password" ></asp:TextBox>--%>
				<asp:TextBox ID="TextBox2" runat="server" Font-Names="Segoe UI" Font-Size="small" TextMode="Password" CssClass="txtBoxL"></asp:TextBox>
			</td>
	...
	<table style="width: 70%; font-family: 'Segoe UI'; font-size: small; float: left; background-color: lightgrey; border-spacing: 0px; margin-left: 0px; padding-left: 0px; padding-right: 0px;">
		<tr style="height: 26px; ">
			<td style="border: 1px solid #000000; width: 200px; background-color: lightgray;" colspan="3" rowspan ="16"></td>
			<td style="border: 1px solid #000000; width: 5px; background-color: lightgray;"></td>
			<td style="border: 1px solid #000000; width: 600px; background-color: lightgray;" colspan="8"></td>
		</tr>
		<tr style="height: 5px; ">
			<td style="border: 1px solid #000000; width: 5px; background-color: lightgray;"></td>
			<td style="border: 1px solid #000000; width: 600px; background-color: lightgray;" colspan="8"></td>
