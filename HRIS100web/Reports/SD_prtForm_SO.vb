...
Public Class SD_prtForm_SO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AOS100web.SD_prtForm_SO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSD_prtForm_SO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SD_prtForm_SO = New SD_prtForm_SO()
        rpt.Site = Me.Site
        Return rpt
    End Function
