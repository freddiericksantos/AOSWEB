...
Public Class SD_prtForm_SO_chem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AOS100web.SD_prtForm_SO_chem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSD_prtForm_SO_chem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SD_prtForm_SO_chem = New SD_prtForm_SO_chem()
        rpt.Site = Me.Site
        Return rpt
    End Function
