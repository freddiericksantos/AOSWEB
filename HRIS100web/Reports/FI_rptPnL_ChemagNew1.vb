...
Public Class FI_rptPnL_ChemagNew
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FI_rptPnL_ChemagNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AOS100web.FI_rptPnL_ChemagNew.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFI_rptPnL_ChemagNew
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FI_rptPnL_ChemagNew = New FI_rptPnL_ChemagNew()
        rpt.Site = Me.Site
        Return rpt
    End Function
