...
Public Class FI_rptCOS_Chemag
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AOS100web.FI_rptCOS_Chemag.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFI_rptCOS_Chemag
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FI_rptCOS_Chemag = New FI_rptCOS_Chemag()
        rpt.Site = Me.Site
        Return rpt
    End Function
